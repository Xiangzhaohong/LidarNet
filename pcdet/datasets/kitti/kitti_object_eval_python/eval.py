...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    CLASS_NAMES = ['car', 'pedestrian', 'cyclist', 'van', 'person_sitting', 'truck', 'tricycle', 'motorcycle', 'big_vehicle', 'huge_vehicle', 'cone']#, 'tricycle', 'motorcycle', 'big_vehicle', 'huge_vehicle', 'cone']
    MIN_HEIGHT = [40, 25, 25]
    MAX_OCCLUSION = [0, 1, 2]
...
def do_eval(gt_annos,
    ...
    if PR_detail_dict is not None:
        ...
        PR_detail_dict['bev-recall'] = ret['recall']
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    overlap_0_7 = np.array([[0.7, 0.5, 0.5, 0.7, 0.5, 0.7, 0.7, 0.5, 0.7, 0.7, 0.5],     #, 0.7, 0.5, 0.7, 0.7, 0.5
                            [0.7, 0.5, 0.5, 0.7, 0.5, 0.7, 0.7, 0.5, 0.7, 0.7, 0.5],     # , 0.7, 0.5, 0.7, 0.7, 0.5
                            [0.7, 0.5, 0.5, 0.7, 0.5, 0.7, 0.7, 0.5, 0.7, 0.7, 0.5]])#, 0.7, 0.5, 0.7, 0.7, 0.5
    overlap_0_5 = np.array([[0.7, 0.5, 0.5, 0.7, 0.5, 0.5, 0.7, 0.5, 0.7, 0.7, 0.5],    #, 0.7, 0.5, 0.7, 0.7, 0.5
                            [0.5, 0.25, 0.25, 0.5, 0.25, 0.5, 0.5, 0.25, 0.5, 0.5, 0.25],#, 0.5, 0.5, 0.25, 0.5, 0.5, 0.25
                            [0.5, 0.25, 0.25, 0.5, 0.25, 0.5, 0.5, 0.25, 0.5, 0.5, 0.25]])#, 0.5, 0.5, 0.25, 0.5, 0.5, 0.25
