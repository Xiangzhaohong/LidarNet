...
def create_robosense_infos(dataset_cfg,class_names,data_path,save_path,workers=4):
    ...
    files_list_label_train = random.sample(files_list_label,int(TRAIN_RATIO_OF_ALL_LABELS*len(files_list_label))+1)
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__()>1 and sys.argv[1] == 'create_robosense_infos':
        ...
        create_robosense_infos(
            ...
            data_path='/home/xjtuiair/KITTI_PCDet/datasets/',
            save_path='/home/xjtuiair/KITTI_PCDet/datasets/'
        )
