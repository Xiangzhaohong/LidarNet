...
class NuScenesDataset(DatasetTemplate):
    ...
    def get_lidar_with_sweeps(self, index, max_sweeps=1):
        ...
        for k in np.random.choice(len(info['sweeps']), max_sweeps - 1, replace=False):
            temp_path = self.root_path / info['sweeps'][k]['lidar_path']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='/home/syang/Projects/OpenPCDet/tools/cfgs/dataset_configs/nuscenes_dataset.yaml', help='specify the config of dataset')
    ...
    if args.func == 'create_nuscenes_infos':
        ...
        ROOT_DIR = Path('/home/syang/Data/nuscenes')
