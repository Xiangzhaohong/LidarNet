...
class AnchorHeadTemplate(nn.Module):
    ...
    def build_losses(self, losses_cfg):
        # default is FocalLoss, if gamma==0 ==> weight softmax loss
        gamma = 2.0 if losses_cfg.get('CLS_LOSS_TYPE', None) is None else 0.0
        self.add_module(
            'cls_loss_func',
            loss_utils.SigmoidFocalClassificationLoss(alpha=0.25, gamma=gamma)
        )
    ...
    def get_cls_layer_loss(self):
        ...
        negative_cls_weights = negatives * neg_cls_weight
